...
public class SRMultiDemandSimul extends SRSimul implements IMultiDemandSimulator,ISimulator{

	
	
	public SRMultiDemandSimul(NetworkTopology topology) {
		this(topology,LoadBalancer.DEFT);
	}
	
	
	public SRMultiDemandSimul(NetworkTopology topology, LoadBalancer lb) {
		super(topology,lb);
	}
