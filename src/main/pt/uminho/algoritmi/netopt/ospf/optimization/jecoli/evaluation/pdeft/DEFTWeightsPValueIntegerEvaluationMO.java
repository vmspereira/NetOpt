...
public class DEFTWeightsPValueIntegerEvaluationMO extends AbstractMultiobjectiveEvaluationFunction<ILinearRepresentation<Integer>> 
{
	...
	public DEFTWeightsPValueIntegerEvaluationMO (NetworkTopology topology, Demands[] demand)
	{
	...
	public DEFTWeightsPValueIntegerEvaluationMO (NetworkTopology topology, Demands[] demand,boolean use_deft)
	{
		super(false); //sets isMaximization
		this.topology = topology;
		this.demands = demand;
	...
	protected Double[] evalPValues(double[] pValues,int[] weights) throws DimensionErrorException
	{
		...
		fitness[0]= simul.evalPValues(pValues,weights,this.demands[0]);
		fitness[1]= simul.evalPValues(pValues,weights,this.demands[1]);
		return fitness;
	}
