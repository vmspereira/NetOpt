...
public class SRPValueLoadIntegerEvaluationMO extends AbstractMultiobjectiveEvaluationFunction<ILinearRepresentation<Integer>> 
{
	...
	protected double[][] fixedLoads;
	protected Demands totalDemands;
		
	public SRPValueLoadIntegerEvaluationMO (NetworkTopology topology, Demands demand, int[] weights,double[][] loads,Demands totalDemands)
	{
		super(false); //sets isMaximization
		this.topology = topology;
		this.demands = demand;
		this.weights = weights;
		this.fixedLoads=loads;
	...
	protected Double[] evalPValues(double[] pValues) throws DimensionErrorException
	{
		...
		simul.getLoads().addLoads(this.fixedLoads);
		res1= simul.congestionMeasure(simul.getLoads(), totalDemands);
	...
	public IEvaluationFunction<ILinearRepresentation<Integer>> deepCopy()
			throws Exception {
		SRPValueLoadIntegerEvaluationMO e = new SRPValueLoadIntegerEvaluationMO(this.topology.copy(),demands.copy(),this.weights.clone(), this.fixedLoads.clone(), this.totalDemands.copy());
