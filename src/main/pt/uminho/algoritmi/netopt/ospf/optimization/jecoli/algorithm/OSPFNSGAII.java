...
public class OSPFNSGAII extends NSGAII<ILinearRepresentation<Integer>,ILinearRepresentationFactory<Integer>> implements AlgorithmInterface<Integer> {

	
	
public OSPFNSGAII(NSGAIIConfiguration<ILinearRepresentation<Integer>,ILinearRepresentationFactory<Integer>> configuration)
			throws Exception {
		super(configuration);
	}
