 ...
 *
 */
public class SRPValueIntegerEvolutionaryAlgorithm extends EvolutionaryAlgorithm<ILinearRepresentation<Integer>, ILinearRepresentationFactory<Integer>> implements AlgorithmInterface<Integer>{
	...
	public SRPValueIntegerEvolutionaryAlgorithm(EvolutionaryConfiguration<ILinearRepresentation<Integer>, ILinearRepresentationFactory<Integer>> configuration)
			throws Exception {
			super(configuration);
	}
