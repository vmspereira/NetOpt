...
public class SRPValueEvaluation extends AbstractEvaluationFunction<ILinearRepresentation<Double>> 
{
	...
	public SRPValueEvaluation (NetworkTopology topology, Demands demand, int[] weights)
	{
