 ...
 *
 */
public class OSPFEvolutionaryAlgorithm extends EvolutionaryAlgorithm<ILinearRepresentation<Integer>,ILinearRepresentationFactory<Integer>> implements AlgorithmInterface<Integer>{
	...
	public OSPFEvolutionaryAlgorithm(EvolutionaryConfiguration<ILinearRepresentation<Integer>,ILinearRepresentationFactory<Integer>> configuration)
			throws Exception {
			super(configuration);
	}
