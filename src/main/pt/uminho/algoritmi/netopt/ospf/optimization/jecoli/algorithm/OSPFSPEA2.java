...
public class OSPFSPEA2 extends SPEA2<ILinearRepresentation<Integer>,ILinearRepresentationFactory<Integer>> implements AlgorithmInterface<Integer>{


public OSPFSPEA2(SPEA2Configuration<ILinearRepresentation<Integer>, ILinearRepresentationFactory<Integer>> configuration)
			throws Exception {
		super(configuration);
}
