...
public class DEFTPValueIntegerEvaluationMO extends AbstractMultiobjectiveEvaluationFunction<ILinearRepresentation<Integer>> 
{
	...
	private double divider=100.0; 
	
		
	public DEFTPValueIntegerEvaluationMO (NetworkTopology topology, Demands demand, int[] weights)
	{
	...
	public DEFTPValueIntegerEvaluationMO (NetworkTopology topology, Demands demand, int[] weights,boolean use_DEFT)
	{
		super(false); //sets isMaximization
		this.topology = topology;
		this.demands = demand;
	...
	public DEFTPValueIntegerEvaluationMO (NetworkTopology topology, Demands demand, int[] weights,boolean use_DEFT,int divider)
	{
		super(false); //sets isMaximization
		this.topology = topology;
		this.demands = demand;
